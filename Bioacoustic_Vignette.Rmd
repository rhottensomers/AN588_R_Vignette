...
Sofia: Add pictures (of the bird we are analyzing) *i added a picture but am not sure if the path i used will work for everyone?*
...
##Preliminaries: 
Install these packages in *R*:{bioacoustics}, {warbleR}, {randomForest}
