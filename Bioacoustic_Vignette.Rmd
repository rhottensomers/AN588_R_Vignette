...
threshold_detect <- threshold_detection(
  STREPV, threshold = 5, time_exp = 1, min_dur = 140, max_dur = 440, 
  ...
  metadata = FALSE, spectro_dir = file.path(getwd(), "Spectros"), time_scale = 1, 
...
TD <- threshold_detection(
  STREPV, 
  threshold = 2,   time_exp = 1,  min_dur = 140,   max_dur = 440,   min_TBE = 10,  max_TBE = 5000, 
  EDG = 0.996, 
  LPF = 10000, 
  HPF = 1000, 
  FFT_size = 256, 
...
#this is the same
BD <- blob_detection(
  STREPV, # Either a path to an audio file (see ?read_audio), or a Wave object
