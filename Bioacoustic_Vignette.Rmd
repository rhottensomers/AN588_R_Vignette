...
TD <- threshold_detection(
  ...
  LPF = 6000, 
  HPF = 1000, 
  start_thr = 60, #start threshold for an audio event, 20dB is recommended for birds, we can move from there
...
temp_slice <- c(from = 5, to = 9) # in seconds
ticks <- c(from = 1000, to = 20000, by = 1000)
...
label_spectro(wave = wav, #Wave object,
